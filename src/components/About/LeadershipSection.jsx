...
export default function LeadershipSection() {
  return (
    <div className="py-16 px-6 sm:px-8 lg:px-12 bg-gray-800">
      <div className="max-w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col md:flex-row gap-10 justify-center">
            {/* HOD */}
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl hover:-translate-y-3 transition-transform duration-300 border-2 border-yellow-400">
              <img 
                src={leadershipData.hod.image} 
                alt={leadershipData.hod.name}
                className="w-52 h-52 rounded-full object-cover mx-auto mb-6 border-4 border-yellow-400"
              />
            ...
            {/* Faculty Coordinator */}
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl hover:-translate-y-3 transition-transform duration-300">
              <img 
          ...
          <div className="text-center">
            <div className="mb-8">
              <img 
                ...
                alt="Core Team"
                className="w-80 h-auto rounded-2xl mx-auto border-2 border-white border-opacity-20 shadow-2xl"
              />
            </div>
